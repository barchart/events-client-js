...
module.exports = (() => {
	 ...
	 * @param {Object} credentials - The credentials for the API.
	 * @param {String} credentials.username - The username for the API.
	 * @param {String} credentials.password - The password for the API.
	 */
	class ReportGateway extends Disposable {
		...
		/**
		 * Downloads a report (as a CSV), assuming the report has been completed.
		 *
		 * @public
		 * @param {String} source
